        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Rental App</h3>
                </a>
...
if(rs1.next())
{
   ...
   PreparedStatement ps1 = con.prepareStatement("insert into order_tbl values(?, ?, ?, ?, ?, ?)");
	...
	ps1.setString(5,User1.getEmail());
	ps1.setString(6,status);
	int p = ps1.executeUpdate();
	if(p>0)
	{
		response.sendRedirect("viewMyReq.jsp");
	}
}
}
catch(Exception e)
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Chavan's Rental App</a>, All Right Reserved to Dev Chavan. 
                        </div>
